...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/maryjane.conf}
...
then
  ...
  echo -e "To safely generate a maryjane.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example maryjane.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-maryjane-conf.sh.
##
...
# parse the output from maryjaned --help
