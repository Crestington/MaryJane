...
MaryJane Core version 4.22.8 is now available from:

[https://download.maryjane.com/bin/maryjane-core-4.22.8/](https://download.maryjane.com/bin/maryjane-core-4.22.8/)
...
### MaryJane commit history 4.22.8
...
### MaryJane commit history 4.22.7
 ...
 - #add4311cd tests: update rpcnested for maryjane (John Nash)
 - #fa19e3a8e tests: update uri tests for maryjane (John Nash)
 - #4a6c0297e qt: add missing override (John Nash)
 
### MaryJane commit history 4.22.6
