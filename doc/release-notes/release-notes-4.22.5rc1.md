...
MaryJane Core version 4.22.5 rc1 is available from:

[MaryJane Core version 4.22.5rc1]<https://download.maryjane.com/bin/maryjane-core-4.22.5/rc1/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  [Github Issues]<https://github.com/maryjane-project/maryjane-0.22/issues>
...
**WARNING:** This is a candidate release of MaryJane Core version 4.22.5, by running this version you acknowledge that there
...
installer (on Windows) or just copy over `/Applications/MaryJane-Qt` (on macOS)
