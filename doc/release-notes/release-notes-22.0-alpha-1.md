...
MaryJane Core version 22.0 alpha 1 is available from:

  <https://https://download.maryjane.com/bin/maryjane-core-4.22.0/alpha/8aebab86b834/>
...
MaryJane Core version 22.0 alpha 1 is intended to run on testnet only.
...
**WARNING:** This is an alpha release of MaryJane Core version 22.0, by running this version you acknowledge that there
...
- `checkupdates` will return the currently installed and available remote versions.
