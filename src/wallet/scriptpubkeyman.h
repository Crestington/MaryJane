...
public:
    ...
    /* Returns true if HD bip39 is enabled */
    virtual bool IsBip39Enabled() const { return false; }

    /* Returns true if HD bip44 is enabled */
    virtual bool IsBip44Enabled() const { return false; }
...
public:
    ...
    bool IsBip44Enabled() const override;
